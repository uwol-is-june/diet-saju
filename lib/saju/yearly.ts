...
export const THEME_NOTE: Record<SipsinGroup, string> = {
  비겁:
    "내 힘으로 밀고 나가는 결이 강해진다. 사람과 겨루는 자리가 늘어나므로, 이기는 쪽보다 오래 가는 쪽을 고르는 판단이 필요하다.",
  식상:
    "내놓고 만드는 결이 강해진다. 표현하고 시작하기에는 좋지만 벌여 놓은 것을 거두는 힘은 따로 챙겨야 한다.",
  재성:
    "밖으로 움직이는 결이 강해진다. 일정과 씀씀이가 함께 늘기 쉬우므로 무엇을 남길지 미리 정해 두는 편이 좋다.",
  관성:
    "틀이 조여지는 결이다. 맡는 몫과 책임이 늘어나므로 감당할 범위를 먼저 그어 두면 덜 흔들린다.",
  인성:
